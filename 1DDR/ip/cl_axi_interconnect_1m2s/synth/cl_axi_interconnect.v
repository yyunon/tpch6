...
module cl_axi_interconnect
   (ACLK,
    ...
    S01_AXI_wstrb,
    S01_AXI_wvalid);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ACLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ACLK, ASSOCIATED_BUSIF S00_AXI:M00_AXI:M01_AXI:M02_AXI:M03_AXI:S01_AXI, ASSOCIATED_RESET ARESETN, CLK_DOMAIN cl_axi_interconnect_ACLK, FREQ_HZ 250000000, INSERT_VIP 0, PHASE 0.000" *) input ACLK;
