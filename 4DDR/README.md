...
This Fletcher design is based on the CL_DRAM_DMA CustomLogic Example with 4 DDR controllers.
In this version of the design, most of the example logic is left in place.
...
The sh_cl_sda\_ AXI-Lite bus has been disconnected in this design.
